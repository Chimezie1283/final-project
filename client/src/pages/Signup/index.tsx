      ...
      <div className="rounded-xl bg-bgColor-soft w-full p-8 border border-borderColor">
        ...
        >
          ...
          <p className="text-textColor-soft opacity-60 text-sm">
            By clicking Create Account, you agree to all our policies.
          </p>
          <BasicButton
            variant="contained"
            radius="small"
